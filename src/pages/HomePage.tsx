                        ...
                        <div>
                            <div className="mb-6 sm:mb-8 flex flex-col">
                                ...
                                >
                                    ...
                                    Processing, and Web Development. Passionate
                                    about creating innovative solutions with
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <Linkedin className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 cursor-none hover:text-primary" />
                                        </a>
                                        <a
                                            ...
                                            className="transition-colors"
                                        >
                                            <Github className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 cursor-none hover:text-primary" />
                                        </a>
                                        <a
                                            ...
                                            className="transition-colors"
                                        >
                                            <Instagram className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 cursor-none hover:text-primary" />
                                        </a>
                                    </motion.div>
                                </motion.div>
                            </div>
                ...
                <div className="max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
                    <div className="text-center mb-8 sm:mb-12 md:mb-16">
                        ...
                        <p className="max-w-2xl mx-auto text-sm sm:text-base md:text-lg">
                            A selection of my award-winning projects and
                    ...
                    <div className="text-center mt-8 sm:mt-12 md:mt-16">
                        <Button
                            asChild
                            size="lg"
                            className="bg-primary hover:bg-primary/90 rounded-full px-4 sm:px-6 md:px-8 cursor-none"
                        >
                            <Link
                                to="/projects"
                ...
                <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
                    ...
                    <div className="relative rounded-xl">
                        <div className="overflow-hidden relative rounded-xl">
                            ...
                            <Button
                                onClick={prevImage}
                                className="absolute top-1/2 left-2 sm:left-4 transform -translate-y-1/2 bg-black/50 text-white p-1 sm:p-2 rounded-full hover:bg-black/70 transition cursor-none"
                            >
                                <ChevronLeft className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
                            </Button>
                            <Button
                                onClick={nextImage}
                                className="absolute top-1/2 right-2 sm:right-4 transform -translate-y-1/2 bg-black/50 text-white p-1 sm:p-2 rounded-full hover:bg-black/70 transition cursor-none"
                            >
                    ...
                    <div className="flex flex-col lg:flex-row items-center text-center">
                        ...
                        >
                            ...
                            <p className="max-w-2xl mx-auto lg:mx-0 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 md:mb-10">
                                Interested in collaborating on a project or have
                                a job opportunity? I'm always open to discussing
                                new ideas and opportunities.
                            </p>
                            <Button
                                asChild
                                size="lg"
                                className="bg-primary hover:bg-primary/90 rounded-full px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 text-base sm:text-lg cursor-none"
                            >
                                <Link
                                    to="/contact"
                                    className="flex items-center justify-center"
