...
const ContactPage = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      label: "GitHub",
      color:
        "bg-[#333]/10 text-[#333] dark:text-white hover:bg-[#333] hover:text-white",
        ...
        <div className="container max-w-[1700px] mx-auto px-4 sm:px-6">
          <div className="mb-8 sm:mb-10 text-center">
            ...
            <p className="text-muted-foreground text-sm sm:text-base max-w-xs sm:max-w-lg md:max-w-2xl mx-auto px-2">
              Connect with me through social media or email. I'd love to hear
              from you!
            </p>
          </div>
                  ...
                  >
                    <div
                      className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-4 ${
                        social.color.includes("bg-[#0077B5]")
                          ? "border-[#0077B5]"
                          : social.color.includes("bg-[#333]")
                          ? "border-[#333] dark:border-white"
                          : social.color.includes("bg-[#E1306C]")
                          ? "border-[#E1306C]"
                          : "border-primary"
                      } 
              ...
              {contactInfo.map((item, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className="bg-card p-4 sm:p-6 rounded-xl border border-border hover:shadow-lg transition-all flex items-center"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    whileHover={{ y: -5 }}
