                ...
                <div className="max-w-[1920px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground max-w-xs sm:max-w-lg md:max-w-2xl mx-auto text-sm sm:text-base md:text-lg">
                            A showcase of my technical projects, research work,
                            and hackathon achievements spanning AI/ML, web
                                                        ...
                                                        <div className="absolute top-5 right-3 sm:top-5 sm:right-5 z-30">
                                                            <div className="flex cursor-none">
                                                                <a
                                                                    ...
                                                                    className="text-primary hover:text-primary/80 transition-colors cursor-none"
                                                                >
                                                                    <div className="flex justify-center items-center gap-1 sm:gap-2 cursor-none">
                                                                        <Link className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 cursor-none" />
                                                                        <span className="text-[10px] sm:text-xs md:text-sm hidden sm:inline truncate max-w-[100px] sm:max-w-[150px] cursor-none">
                                                                            {
                                                                                project.liveLink
                                                                            }
                                                                        </span>
                                                    ...
                                                    <div className="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 mt-auto pt-3 sm:pt-0 sm:absolute sm:bottom-5">
                                                        {project.githubLink && (
                                                            <Button
                                                                ...
                                                                variant="outline"
                                                                size="sm"
                                                                className="h-7 sm:h-8 md:h-9 px-2 py-0 sm:px-3 sm:py-1 cursor-none"
                                                            >
                                                                <a
                                                                    href={
                                                                        project.githubLink
                                                                    ...
                                                                    target="_blank"
                                                                    rel="noopener noreferrer"
                                                                    className="flex items-center gap-1 sm:gap-2 cursor-none"
                                                                >
                                                                    <Github className="h-2.5 w-2.5 sm:h-3 sm:w-3 md:h-4 md:w-4" />
                                                                    <span className="text-[12px] sm:text-xs md:text-sm cursor-none">
                                                                        GitHub
                                                                    </span>
                                                                </a>
                                                            </Button>
