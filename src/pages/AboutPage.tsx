...
const AboutPage = () => {
    ...
    const experience = [
        ...
        },
        {
            ...
            company: "Business & Innovation Program (BIP), Perth, Australia",
    ...
    const leadership = [
        ...
        },
        {
            ...
            organization:
                "Xenesis'24, LDRP Institute of Technology and Research",
            period: "Feb 2024",
            description:
    ...
    const certifications = [
        {
            image: "https://res.cloudinary.com/dfkccowgw/image/upload/v1744825774/gate_jgcdje_bahmdi.avif",
                ...
                <div className="container max-w-[1700px] mx-auto px-4 sm:px-6 relative z-10">
                    <div className="mb-10 sm:mb-16 text-center">
                        ...
                        <p className="text-sm sm:text-base text-muted-foreground max-w-xs sm:max-w-lg md:max-w-2xl mx-auto mb-6 sm:mb-8">
                            Computer Engineering student with expertise in
                            Machine Learning, Web Development, and Cloud
                            Computing.
                        </p>
                        <Button className="rounded-full bg-primary/30 hover:bg-primary/70 transition-all duration-300 cursor-none">
                            <a
                                href={resume_Url}
                                target="_blank"
                            ...
                            >
                                <p className="text-black dark:text-white text-base sm:text-lg p-1 sm:p-2 rounded-full no-underline cursor-none">
                                    My Resume
                                </p>
                            </a>
                        </Button>
